...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "MARVEL_VS__CAPCOM__CLASH_OF_SUPER_HEROES_RECOMP_PROJECT_ROOT",
    .build_dir_env = "MARVEL_VS__CAPCOM__CLASH_OF_SUPER_HEROES_RECOMP_BUILD_DIR",
    .force_setup_env = "MARVEL_VS__CAPCOM__CLASH_OF_SUPER_HEROES_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.59_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Marvel_vs__Capcom__Clash_of_Super_Heroes__Recompiled",
    .prepare_note =
